define(['text!pages/learn/user/user.html', 'css!pages/learn/user/user','pages/learn/user/usermeta', 'uuitree', 'uuigrid', 'config/sys_const'], 
                            ...
                            if (res) {
                                if (res.success == 'success') {
                                    if (res.detailMsg.data) {
                                    	console.log(res.detailMsg.data);
                                        ...
                                        //viewModel.userDa(res.detailMsg.data.content, {unSelect: true});
                                        if(totleCount == 0){
