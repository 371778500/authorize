package com.yonyou.upesn.service.impl;
...
import com.yonyou.appbase.util.HttpReq;
import com.yonyou.appbase.util.WXBizMsgCrypt;
...
public class AuthAppSuitesImp implements IAuthAppSuites {
	...
	public String getAccessToken(String suiteAccessToken, String suiteKey,
		...
		if(data == null){
			...
			cache.setAndExpireInPipeline("access_token", accessToken, Integer.parseInt(expiresIn));
			return accessToken;
		}
	}
